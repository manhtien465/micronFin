                ...
                {data.teams.map((team: { id: React.Key; image:any, name: string; position: string }) =>
                    <div className="flex flex-col w-full sm:w-1/3 rounded-lg border border-solid border-[#E5E5E5] ">
                        <Image
                            ...
                            height={104}
                        />
                        <div className="text-[#2D64F0] text-xl leading-[30px] font-semibold sm:text-[32px] sm:font-medium lg:leading-10 tracking-tight text-center mb-2 mt-4 sm:mt-6">{team.name}</div>
                        <div className="text-[#431805] font-bold text-base leading-7 sm:font-normal sm:leading-8 sm:text-lg text-center mb-4 sm:mb-6">{team.position}</div>
                    </div>
                )}
            </div>
